...
5. Importa 55 liste di blocco in Pi-hole
...
Lo script `install.sh` importa automaticamente **55 liste** da `pihole/adlists.txt`, coprendo:
...
| Mega-liste consolidate | OISD Big, 1Hosts Pro, GoodbyeAds |
